...
exports.createUserValidations = [
    (0, express_validator_1.body)("name")
        ...
        .custom(function (input) { return __awaiter(void 0, void 0, void 0, function () {
        var person;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, model_1.default.findOne({ name: input })];
                case 1:
                    person = _a.sent();
                    if (person)
                        throw Error();
        ...
        .withMessage("This person exists"),
    ...
    function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, express_validator_1.validationResult)(req)];
                case 1:
                    errors = _a.sent();
                    if (!errors.isEmpty())
